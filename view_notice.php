...
<div class="card" style="width: 1110;height:500px">
  <div class="card-body"><br>
<h5 align="center"style="font-size:45px;color:red" class="card-title">NOTICES</h5><br><br><br>
...
if(isset($_GET['noticeid']))
{
  ...
  $query = mysqli_query($connection,"SELECT * from notice WHERE id = '$noticeid' ");

  $noticearray = mysqli_fetch_assoc($query);
}
